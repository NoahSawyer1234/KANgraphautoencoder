...
def GAEKAN_latent_train(datafile, learning_rate, enc_epochs, num_harmonics,
    ...
    torch.save(ae_model.encoder.state_dict(), 'GAEKAN_mini_trained_encoder_500k.pth')
    
if __name__ == '__main__':
    enc_epochs = 500
    GAEKAN_latent_train('small_molecules_500k_512',0.001,enc_epochs,1,1,1,1,32,64,
